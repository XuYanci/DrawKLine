...
-(void)addRightBorderWithWidth: (CGFloat)width andHeight:(CGFloat)height andColor:(UIColor*)color{
    [self addOneSidedBorderWithFrame:CGRectMake(self.frame.size.width-width, (self.frame.size.height-height)/2, width, height) andColor:color];
}
